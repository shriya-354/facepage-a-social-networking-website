.02<%@page import="java.io.PrintWriter"%>
...
<head>
    ...
    <meta name="description" content="COEPs Social Network">
    <meta name="author" content="Vaibhav Murudkar">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">FAC3PAGE</a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>Welcome to FAC3PAGE </h1>
                <!-- <img style="position:relative;top:50%;left:46%;" src="img/.png" class="img-responsive" alt=""> -->
                <hr>
                <p style="color:#fff;">COEP's own social network.</p>
            </div>
        </div>
    </header>
